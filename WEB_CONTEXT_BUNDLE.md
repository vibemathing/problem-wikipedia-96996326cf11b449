...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-96996326cf11b449"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-96996326cf11b449",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-96996326cf11b449",
        "url": "https://en.wikipedia.org/wiki/Weaire%E2%80%93Phelan_structure"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The Kelvin problem on minimum-surface-area partitions of space into equal-volume cells, and the optimality of the Weaire–Phelan structure as a solution to the Kelvin problem",
      "version": 1
    },
    "title": "The Kelvin problem on minimum-surface-area partitions of space into equal-volume cells, and the optimality of the Weaire–Phelan structure as a solution to the Kelvin problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "84a9c4c1ef598fb1b9d39ad079c61ed595bcdee9ba32f32df97ae1d980496690"
}
```
